...
import typing
import asyncio
from typing import Any, List, Dict, Tuple, Any, Callable, cast, Union, TypedDict, Type
...
from ._phase_decorator import phase_step
...
class _BaseEvent(typing.Protocol):
    ...
    _task_id: str
    _phase: EventPhase
    exec_result: typing.Any
    exec_status: bool
    checkpoint_manager: VolnuxCheckPointManager
    run_bypass_event_checks: bool
    _init_args: dict
    _call_args: dict
    _external_resources: typing.Dict[str, ResourceState]
    ...
    def register_resource(
        ...
        resource_name: str,
        resource: typing.Any,
        provider: typing.Union[str, Type[ResourceProvider]],
    ) -> None: ...
    ...
    async def _retry(
        self,
        func: Callable[[typing.Any], typing.Tuple[bool, typing.Any]],
        /,
    ...
    async def _run_step(self, step, *args, **kwargs) -> typing.Any: ...

    async def _process_wrapper(self, *args, **kwargs) -> Union[EventResult, tuple]: ...
...
class EventCheckPointingMixin:
    ...
    def _setup_event(
        ...
        *args: typing.Tuple[typing.Any],
        ...
        self._external_resources: typing.Dict[str, ResourceState] = {}
    ...
    async def enqueue_checkpoint(self) -> None:
        if self.checkpoint_manager is None:
            ...
            #     raise RuntimeError("Checkpointing is required but manager is unavailable")
            return
