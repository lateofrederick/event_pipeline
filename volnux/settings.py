...
# Remote executor: retry + circuit breaker (transient failures when submitting to managers)
REMOTE_RETRY_MAX_ATTEMPTS = 5
REMOTE_RETRY_BASE_DELAY = 0.1
REMOTE_RETRY_MAX_DELAY = 30.0
REMOTE_RETRY_JITTER_RATIO = 0.2
REMOTE_CIRCUIT_FAILURE_THRESHOLD = 5
REMOTE_CIRCUIT_RECOVERY_TIMEOUT = 30.0
REMOTE_CIRCUIT_HALF_OPEN_MAX_CALLS = 1
